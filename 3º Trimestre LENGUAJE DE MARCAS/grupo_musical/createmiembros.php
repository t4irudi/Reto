...
<html lang="es" dir="ltr">
  ...
  <body>
    ...
    <div id="cuerpo">
      <form id="formulario" action="altamiembro.php" method="post">

        <label for="nombre">Nombre</label>
        <input type="text" id="nombre" name="nombre" placeholder="Escriba el nombre"/><br>
        <label for="instrumento">Instrumento</label>
        <input type="text" id="instrumento" name="instrumento" placeholder="Escriba su instrumento"/><br>
        <label for="fecha_nacimiento">Fecha de nacimiento</label>
        <input type="date" id="fecha_nacimiento" name="fecha_nacimiento"/><br>
        <label for="ciudad">ciudad</label>
        <input type="text" id="ciudad" name="ciudad" placeholder="Escriba su ciudad"/><br>
